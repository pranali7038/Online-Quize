<?php 
	include 'db.php';
	session_start(); 
	//Set Question Number from databse
	$number = $_GET['n'];

	//Query for the Question
	$query = "SELECT * FROM questions WHERE question_number = $number";

	// Get the question and run question
	$result = mysqli_query($connection,$query); //$connection is connection handle
	$question = mysqli_fetch_assoc($result); //convert values in associative array
